...
<!-- Page Content -->
    <div class="container">
        <div class="row">
            ...
            <form id="SignupForm" class="ui grid form" role="form" method="post">
            ...
            <div class="row field">
                ...
                <div class="row">
                    <div class="eight wide column">
                        <input id="submit" name="submit" type="submit" value ="Add" class="ui primary button">
